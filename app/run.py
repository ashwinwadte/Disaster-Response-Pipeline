    ...
    graphs = [
        ...
        },
        {
            'data': [
                Bar(
                    ...
                    name='news',
                    orientation = 'h',
                    marker = dict(color='#E1396C', line=dict( color='#000000', width=1.5))
                    ),
                ...
                name='direct',
                orientation = 'h',
                marker = dict(color='#febfb3',line=dict( color='#000000', width=1.5))
                ),
                ...
                name='social',
                orientation = 'h',
                marker = dict(color='#96D38C', line=dict( color='#000000', width=1.5))
                )
        ...
        },
        {
            ...
            'layout': {
                ...
                'yaxis': {'title': "Sum"},
                'xaxis': {'title': "Number of Assigned Labels"}
            }
        }
    ]
