...
def load_data(messages_filepath, categories_filepath):
    '''
	Loads messages and category datasets and joins them together using the common id.
...
def clean_data(df):
    '''
    Tidy and clean df.
    Tidies the categories columns, cleans up duplicates
...
def save_data(df, database_filepath):
    '''
    Save the cleaned df to a SQL database
    '''
